...
class PaymentMethodPage:
    def __init__(self, page: Page):
        self.page = page
        self.payment_method_continue_button_locator = '.button-1.payment-method-next-step-button'
        self.payment_info_continue_button_locator = '.button-1.payment-info-next-step-button'
